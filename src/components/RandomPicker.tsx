...
export default function RandomPicker({ places, onSelect }: RandomPickerProps) {
  ...
  const buildSpinList = useCallback(() => {
    ...
    const names: string[] = [];
    // Build a long list of shuffled names for the spin reel
  ...
  const handleSpin = useCallback(() => {
    ...
    // Put the winner near the end of the reel
    ...
    const animate = (now: number) => {
      ...
      // Blur reduces as speed decreases
  ...
  return (
    <div className="bg-border/20 rounded-lg px-3 py-1 overflow-hidden flex-1">
      <div className="flex items-center gap-3 h-full">
          ...
          <>
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col items-center">
                ...
                <span
                  className={`text-sm font-semibold font-mono tabular-nums transition-colors ${
        ...
        {/* Spinning / Result — slot machine reel */}
        ...
        {/* Spacer pushes button right in idle state */}
